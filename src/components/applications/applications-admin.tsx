    ...
    <AppShell title="Plataformas">
      ...
      {modalMode === "edit" ? (
        <Modal
          ...
          footer={(
            <>
              <button className="btn-primary" disabled={saving} type="submit" form="application-edit-form">
        ...
        >
          <form id="application-edit-form" onSubmit={saveApplication} className="space-y-4">
      ...
      {modalMode === "profiles" && activeApplication ? (
        <Modal
          ...
          footer={(
            <>
              <button className="btn-primary" disabled={saving} type="submit" form="application-profiles-form">
                <Save size={17} aria-hidden="true" />
        ...
        >
          <form id="application-profiles-form" onSubmit={saveProfiles} className="space-y-4">
